...
To get inspired, check the [Contribute models](../../ersilia-model-hub/incorporate-models.md) section, look at [existing models](https://ersilia-io/model-hub) in the Hub and our list of [pending models](https://airtable.com/shrTpe45mLKqaHXsc) to incorporate.
