...
As soon as you feel ready to start coding, you should change the _Status_ in the Spreadsheet Hub sheet from _To do_ to _In progress_. Please go to the next page to learn more about how to [Incorporate models to the hub](../ersilia-model-hub/model-contributions.md).

{% content-ref url="../ersilia-model-hub/model-contributions.md" %}
[model-contributions.md](../ersilia-model-hub/model-contributions.md)
{% endcontent-ref %}
...
8. When you are ready to [start coding](../ersilia-model-hub/model-contributions.md), change the _Status_ to _In progress_.
