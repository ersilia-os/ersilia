...
<table><thead><tr><th width="189">Option / Argument</th><th width="97">Type</th><th width="118">Default Value</th><th width="272">Description</th><th data-type="checkbox">Required</th></tr></thead><tbody><tr><td><code>-i, --input</code></td><td>String</td><td><code>None</code></td><td>Pass the input for the model, either as a single SMILES ("CCC"), a SMILES list ("['CCC','CCC']") or a .csv file with only one column with header.</td><td>true</td></tr><tr><td><code>-o, --output</code></td><td>String</td><td><code>None</code></td><td>Specify the file to save the model predictions. This can be a CSV, TSV, or JSON file. If not specified, output is printed on the user's terminal in JSON format.</td><td>false</td></tr><tr><td><code>-b, --batch_size</code></td><td>Integer</td><td><code>100</code></td><td>Specify the batch size for generating model predictions. By default, Ersilia works with batch size of 100 inputs.</td><td>false</td></tr><tr><td><code>--as_table</code> / <code>-t</code></td><td>Flag</td><td><code>False</code></td><td>Print the model predictions in an ASCII table on the terminal.</td><td>false</td></tr></tbody></table>
