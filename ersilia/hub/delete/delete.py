...
class ModelSlugDeleter(ErsiliaBase):
    ...
    def delete(self, model_id: str):
        ...
        model_id : str
            Identifier of the model to be deleted.
        """
        self.logger.info("Removing slug DB entry for {0}".format(model_id))
...
class ModelFetchedEntryDeleter(ErsiliaBase):
    ...
    def delete(self, model_id: str):
        ...
        model_id : str
            Identifier of the model to be deleted.
        """
        self.logger.info("Removing fetched DB entry for {0}".format(model_id))
...
class TmpCleaner(ErsiliaBase):
    ...
    def delete(self):
        ...
        if os.path.exists(self._tmp_dir):
            self.logger.info("Cleaning tmp directory {0}".format(self._tmp_dir))
