...
class ModelFetcher(ErsiliaBase):
    ...
    def _modify_bundle_environment_yml(self, model_id):
        """This function corrects some inconsistencies in default yml file created by conda.
        ...
        yml_file = os.path.join(dir, "environment.yml")
    ...
    def pack(self, model_id):
        ...
        # Slightly modify bundle Dockerfile
